...
def upgrade():
    ...
    op.create_index(
        op.f("ix_comment_timestamps"), "comment", ["timestamps"], unique=False
    )
    op.create_table(
        "likedPosts",
        sa.Column("post_id", sa.Integer(), nullable=True),
    ...
    op.create_index(
        op.f("ix_childcomment_timestamps"), "childcomment", ["timestamps"], unique=False
    )
    op.create_table(
        "likedComments",
        sa.Column("comment_id", sa.Integer(), nullable=True),
    ...
    op.create_index(
        op.f("ix_notification_timestamps"), "notification", ["timestamps"], unique=False
    )
    op.create_table(
